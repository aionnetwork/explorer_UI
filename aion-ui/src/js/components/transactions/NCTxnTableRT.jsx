...
import { nc_numFormatterACSensitive, nc_rawFormat, nc_decimalPrettify,nc_addDecimal,nc_numFormatterAionCoin } from 'lib/NCUtility';
...
class NCTxnTableRTRow extends Component 
{
  render() {
    ...
    let val = nc_numFormatterACSensitive(entity.value);
